%% Walkthrough
% 3DSpineMFE provides |newsfe| class which exposes up to five public
...
% be saved. For example: |C:/3DSpineMFE/data|
%
% _Usage:_
sfe = newsfe('C:/3DSpineMFE/data');
...
% file or a folder. For example: |C:/3DSpineMFE/sources/root_TIFs.zip|
% * *root_VRML* : Path to the dendrite VRML files, can be a compressed .ZIP
% file or a folder. For example: |C:/3DSpineMFE/sources/root_VRMLs.zip|
%
% _Usage:_
root_TIF = 'C:/3DSpineMFE/sources/root_TIFs.zip';
root_VRML = 'C:/3DSpineMFE/sources/root_VRMLs.zip';
...
% folder. For example: |C:/3DSpineMFE/data/SPINE_MAT|, (output of 
...
% |C:/3DSpineMFE/sources/root_insertion_points.zip|.
%
% _Usage:_
%
root_MAT = 'C:/3DSpineMFE/data/SPINE_MAT';
root_ipoints = 'C:/3DSpineMFE/sources/root_insertion_points.zip';
...
% |C:/3DSpineMFE/data/SPINE_NECK_REPAIRED|, (output of repairSpines 
...
% _Usage:_
%
root_neck_repaired = 'C:/3DSpineMFE/data/SPINE_NECK_REPAIRED';
num_curves = 8;
remove_auto = true;
threshold = 2;
...
% |C:/3DSpineMFE/data/SPINE_NECK_REPAIRED|, (output of
